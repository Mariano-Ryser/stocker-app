// components/ProductLimitBadge.jsx
  ...
  return (
    <div className={`container ${status}`}>
      <div className="header">
        <div className="title">
          {getIcon()}
          <span>Límite de artículos</span>
        </div>
        <span className="stats">
          {current} de {max} usado ({percentage}%)
        </span>
      </div>
      ...
      <p className="message">
        {percentage >= 90 
          ? '⚠️ Límite crítico. Considera actualizar tu plan.'
          : percentage >= 75
          ? 'ℹ️ Te estás acercando al límite.'
          : `✅ Espacio disponible: ${max - current} artículos.`
        }
      </p>
